...
import { type DoneCallback, ErrorWithReasonCode, type IStream, type StreamBuilder, type TimerVariant, type VoidCallback } from './shared';
...
export default class MqttClient extends TypedEventEmitter<MqttClientEventCallbacks> {
    ...
    private _incomingQoS2Ids;
    private _receiveMaximum;
    private _deferredReconnect;
    private _currentPump;
    private connackReceived;
    ...
    private _releaseIncomingQoS2Publish;
    private _discardIncomingQoS2State;
    connect(): this;
    ...
    get serverProperties(): IConnackPacket['properties'];
